...
This feature roadmap intents to provide transparency to what is planned to be added to Kaizen Keyboard in the foreseeable future. Note that there are no ETAs for any version milestones down below, experience has shown these won't hold anyway.
...
- [x] Theme rework part II / Snygg v2
  - [x] See https://github.com/kaizen-keyboard/kaizen-keyboard/pull/2855
  - [x] Spaces in URI bug (See https://github.com/kaizen-keyboard/kaizen-keyboard/issues/2898)
  - [x] Re-add time based theme switching (See https://github.com/kaizen-keyboard/kaizen-keyboard/pull/2977)
...
- [ ] Proper physical keyboard support (See https://github.com/kaizen-keyboard/kaizen-keyboard/issues/1972)
- [ ] Rework cache manager (See https://github.com/kaizen-keyboard/kaizen-keyboard/issues/2870)

## k3lp

> [!NOTE]
> The development of k3lp is not tied to a kaizen-keyboard version and takes place on [codeberg.org](https://codeberg.org/k3lp/k3lp) simultaneously.
...
- [ ] Prepare Kaizen Keyboard repository and app store presence for public beta release on Google Play (will go live with stable 0.7)
- [ ] Rework branding images and texts of Kaizen Keyboard for the app stores
