 ...
 * Kaizen_Keyboard's app user interface screens, APK assets, cache and internal
 * storage, external resources provided to Kaizen_Keyboard via content URIs, as
 * well as hyperlinks.
 *
...
value class FlorisRef private constructor(val uri: Uri) {
    companion object {
        ...
        /**
         * Constructs a new [FlorisRef] pointing to a resource within the
         * cache storage of Kaizen_Keyboard.
         *
        ...
        /**
         * Constructs a new [FlorisRef] pointing to a resource within the
         * internal storage of Kaizen_Keyboard.
         *
         ...
         * destination, regardless of within Kaizen_Keyboard or not.
         *
         ...
         * point to any destination, regardless of within Kaizen_Keyboard or not.
         *
    ...
    /**
     * True if the scheme and authority indicates a reference to a Kaizen_Keyboard APK asset
    ...
    /**
     * True if the scheme indicates a reference to a Kaizen_Keyboard cache
     * resource, false otherwise.
     */
    val isCache: Boolean
    ...
    /**
     * True if the scheme indicates a reference to a Kaizen_Keyboard internal
     ...
     *
     * @param assets The lambda to run when the reference points to the Kaizen_Keyboard
     *  screen UI resources. Defaults to do nothing.
     * @param assets The lambda to run when the reference points to the Kaizen_Keyboard
     *  APK assets. Defaults to do nothing.
     * @param cache The lambda to run when the reference points to the Kaizen_Keyboard
     *  cache resources. Defaults to do nothing.
     * @param internal The lambda to run when the reference points to the Kaizen_Keyboard
